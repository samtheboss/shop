          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
              ...
              <Card className="bg-gradient-to-br from-emerald-50 to-green-50 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-emerald-700">${getTotalAllocatedValue().toLocaleString()}</div>
                ...
                <div className="grid gap-3">
                  ...
                  {quantity && selectedItemData && (
                      <div className="p-3 bg-slate-50 rounded-lg border">
                        ...
                        ${(Number.parseInt(quantity) * selectedItemData.price).toFixed(2)}
                      </span>
                        </div>
                      </div>
                  )}
                ...
                <Table>
                  ...
                  <TableBody>
                    {getRecentAllocations().map((allocation, index) => (
                        ...
                        >
                          <TableCell className="text-slate-600">{new Date(allocation.date).toLocaleDateString()}</TableCell>
